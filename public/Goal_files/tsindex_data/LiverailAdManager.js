function LiverailAdManager() {
    ...
    vpaidFrame.onload = function () {
        ...
        vpaidFrame.contentWindow.onerror = function (message, url, linenumber) {
            try {
        ...
        vpaidLoader.onload = function () {
            ...
            LiveRailVPAID.subscribe(function () {
                ...
                TS.Modules.LiveRailVPAIDManager.adStarted = true;
                ...
                eventData.duration  = LiveRailVPAID.getAdDuration();
    ...
    this.load = function () {
        ...
        TS.Modules.LiveRailVPAIDManager.adStarted = false;
        ...
        eventData.LR_ENVIRONMENT = environmentVars.LR_ENVIRONMENT;
    ...
    this.checkAdEnd = function () {
        ...
        if (Math.abs(player.duration - player.currentTime) <= STOP_TIME_BEFORE_AD_END && TS.Modules.LiveRailVPAIDManager.adStarted) {
