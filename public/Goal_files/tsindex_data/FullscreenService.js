TS.Modules.FullscreenService =
{
    ...
    onFullscreenChange: function (event)
    {
        setTimeout(function(){
            ...
            if(!TS.Modules.videoListener.isHLSSupported()) {
                TS.Modules.PlaylistModel.updateUrl();
                var currentTime = TS.Modules.videoView.player.currentTime;
                TS.Modules.videoView.setVideoSrc();
                TS.Modules.videoView.player.currentTime = currentTime;
            }
        }, 100)
    },
    ...
    fullScreenIfiPhone : function () {
        if (!TS.Modules.FullscreenService.isFullscreenOn() && TS.Modules.configService.isIPhone()) {
            TS.Modules.FullscreenService.enterFullScreen();
        }
    }
