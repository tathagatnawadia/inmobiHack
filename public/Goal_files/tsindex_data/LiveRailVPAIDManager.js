...
TS.Modules.LiveRailVPAIDManager = {
    ...
    onAdVideoComplete: function () {
        if (TS.Modules.LiveRailVPAIDManager.videoItem != null) {
            ...
            if(TS.Modules.LiveRailVPAIDManager.adStarted || !TS.Modules.ConfigModel.isPC){
                ...
                if (TS.Modules.VastModel.postRoll) {
                    E.trigger(E.EVENT_START_YUME_POSTROLL, TS.Modules.LiveRailVPAIDManager.moduleName);
                }
                else {
                    E.trigger(E.EVENT_START_YUME_PREROLL, TS.Modules.LiveRailVPAIDManager.moduleName);
                }
            }
