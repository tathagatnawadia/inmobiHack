TS.Modules.postclipview =
{
    ...
    init: function () {
        ...
        this.playlistThumb = null;
        this.addListeners();
    },

    setStyles: function () {
        this.postClipView.css('position', "absolute;");
        ...
        if (this.isVisible) {
            ...
            this.postClipView.css("display"     , "block");
        } else {
            this.postClipView.css("visibility"  , "hidden");
            this.postClipView.css("display"     , "none");
        }
    ...
    updateItems: function () {
        ...
        this.playlistThumb  = TS.Modules.PlaylistModel.thumb;
    ...
    updateHtmlElements : function() {
        ...
        $("#thumbImage").attr("src", this.playlistThumb);
    },

    clearHtmlElements : function() {
        for (var i = 0; i < 4; i++) {
            $("#postclipThumb"      + i).attr("src", "");
            $("#postclipTitle"      + i).text("");
            $("#postclipHoverTitle" + i + " label").text("");
            $("#postClipTime"       + i).text("");
        }
