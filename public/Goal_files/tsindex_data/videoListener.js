TS.Modules.videoListener = {
    ...
    play: function () {
        try {
            if (console && console.info && TS.Modules.videoListener.player.src) {
                console.info("Video play : " + TS.Modules.videoListener.player.src);
            }
        } catch(error) {
            //nothing to do
        }
        ...
        TS.Modules.FullscreenService.fullScreenIfiPhone();
    },
    ...
    onVideoPlay: function () {
        TS.Modules.videoListener.playStarted = true;
    ...
    checkVideoEnd : function()
    {
        ...
        {
            TS.Modules.videoListener.triggerVideoEnd();
        }
    },
    ...
    {
        return this.hlsErrorCount == 0 && !TS.Modules.ConfigModel.isPC;
    },

    triggerVideoEnd : function () {
        if(!TS.Modules.LiveRailVPAIDManager.adStarted && TS.Modules.videoListener.playStarted)  {
            TS.Modules.videoListener.playStarted = false;
