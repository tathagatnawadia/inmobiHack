...
TS.Modules.initialize = {
    ...
    postInitializedMessage: function () {
        ...
        E.trigger(E.EVENT_PLAYER_INIT, TS.Modules.initialize.moduleName);
    },
    ...
    getVideoInfoText: function (eventName) {
        var text = '{ "eventName" : "' + eventName + '"' +
            ...
            ', "channelName" : "'   + this.encodeJson(this.videoInfo.channelName) + '"' +
            ', "playerId" : "'      + this.videoInfo.playerId + '"' +
            ', "videoId" : "'       + this.videoInfo.videoId + '"' +
            ', "videoTitle" : "'    + this.encodeJson(this.videoInfo.videoTitle) + '"' +
    ...
    channelResult: function (result, genre, category, structureModel) {
        ...
        E.bindEvent(E.EVENT_PLAYLIST_LOADED, TS.Modules.initialize.moduleName, TS.Modules.initialize.onPlayListLoaded, TS.Modules.initialize, true);
    },
