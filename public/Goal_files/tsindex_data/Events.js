...
bindEvent: function( _eventName, _module, _callback, destination, firstReceiver )
  ...
  trigger: function( p_eventName, p_module, p_paramObject )
  {
    ...
    if(p_eventName == E.EVENT_SET_VIDEOSRC)
    {
  ...
  EVENT_START_YUME_PREROLL                  : "EVENT_START_YUME_PREROLL",
  EVENT_START_YUME_POSTROLL                 : "EVENT_START_YUME_POSTROLL",
  EVENT_PLAYER_INIT                         : "EVENT_PLAYER_INIT",
  EVENT_YUME_AD_STARTED                     : "EVENT_YUME_AD_STARTED",
  EVENT_YUME_AD_ENDED                       : "EVENT_YUME_AD_ENDED"
};
